...
public class FluentLogger {
    ...
    /**
     * Get fluent logger instance from class cannonincal name, adds the _prefix
     * to any message using the _initialArgs as first replacement parameters
     *
     * @param _class from extract the logger instance
     * @param _prefix prefix to append at the beggining of any message writen to
     * this log
     * @param _initialArgs replacement values to add at the beggining of the
     * message parameters in order to replace into message placeholder
     * @return fluent logger instance
     */
    ...
    /**
     * Get fluent logger instance with the given name, adds the _prefix to any
     * message using the _initialArgs as first replacement parameters
     *
     * @param _logName logger name
     * @param _prefix prefix to append at the beggining of any message writen to
     * this log
    ...
    /**
     * Wraps the given java logging logger instance into a fluent logger one,
     * adds the _prefix to any message using the _initialArgs as first
